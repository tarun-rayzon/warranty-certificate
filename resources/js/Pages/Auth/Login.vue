                                ...
                                <div class="p-2 mt-3">
                                    <form @submit.prevent="submit">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <TextInput id="email" v-model="form.email" type="text" class="form-control"
                                                autofocus placeholder="Please enter email or mobile" required
                ...
                <BRow>
                    <BCol lg="12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} Rayzon. Crafted with <i
                                    class="mdi mdi-heart text-danger"></i> by Rayzon Solar</p>
                        </div>
                    </BCol>
                </BRow>
            </BContainer>
