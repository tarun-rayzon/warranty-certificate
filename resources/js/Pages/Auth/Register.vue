                        ...
                        <BCard no-body class="mt-4">
                            ...
                            <BCardBody class="p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free Rayzon account now</p>
                                </div>
                                <div class="p-2 mt-4">
                ...
                <BRow>
                    <BCol lg="12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} Rayzon. Crafted with <i class="mdi mdi-heart text-danger"></i> by Rayzon Solar</p>
                        </div>
                    </BCol>
                </BRow>
            </BContainer>
