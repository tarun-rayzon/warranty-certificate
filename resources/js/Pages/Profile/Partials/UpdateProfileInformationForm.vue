    ...
    <FormSection @submitted="updateProfileInformation" title="Profile Information" description="Update your account's profile information and email address.">
        ...
        <template #form>
            ...
            <div class="mb-3">
                ...
                <TextInput id="designation" v-model="form.designation" type="text" required autocomplete="designation" :class="{ 'is-invalid': form.errors.designation }" :disabled="user.designation" />
