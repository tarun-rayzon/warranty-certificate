        ...
        <BOffcanvas class="border-0" id="theme-settings-offcanvas"
            ...
            <simplebar class="h-100">
                <div class="p-4">
                    ...
                    <div v-if="layoutType == 'vertical' || (layoutType == 'semibox' && visibility == 'show')"
                        ...
                        <BRow>
                            <BCol cols="4">
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" type="radio" name="data-sidebar-size"
                                        id="sidebar-size-default" v-model="sidebarSize" value="lg" />
                            ...
                            <BCol cols="4">
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" type="radio" name="data-sidebar-size"
                                        id="sidebar-size-compact" v-model="sidebarSize" value="md" />
                            ...
                            <BCol cols="4">
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" v-model="sidebarSize" type="radio"
                                        name="data-sidebar-size" id="sidebar-size-small-hover" value="sm-hover" />
                    ...
                    <div v-if="layoutType == 'vertical'" id="sidebar-view">
                        ...
                        <BRow>
                            <BCol cols="4">
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" v-model="sidebarView" type="radio"
                                        name="data-layout-style" id="sidebar-view-default" value="default" />
                            ...
                            <BCol cols="4">
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" v-model="sidebarView" type="radio"
                                        name="data-layout-style" id="sidebar-view-detached" value="detached" />
                    ...
                    <div v-if="layoutType == 'vertical' || layoutType === 'twocolumn' || (layoutType === 'semibox' && visibility === 'show')"
                        id="sidebar-color">
                        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">
                            Sidebar Color
                        </h6>
                        ...
                        <BRow>
                            ...
                            <BCol cols="4">
                                <button class="btn btn-link avatar-md w-100 p-0 overflow-hidden border collapsed "
                                    type="button" v-b-toggle.collapseBgGradient
                            ...
                            <div class="d-flex gap-2 flex-wrap img-switch p-2 px-3 bg-light rounded">
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" type="radio" v-model="sidebarColor"
                                        name="data-sidebar" id="sidebar-color-gradient" value="gradient">
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" type="radio" v-model="sidebarColor"
                                        name="data-sidebar" id="sidebar-color-gradient-2" value="gradient-2">
                                    <label class="form-check-label p-0 avatar-xs rounded-circle"
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" type="radio" v-model="sidebarColor"
                                        name="data-sidebar" id="sidebar-color-gradient-3" value="gradient-3">
                                    <label class="form-check-label p-0 avatar-xs rounded-circle"
                                ...
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" type="radio" v-model="sidebarColor"
                                        name="data-sidebar" id="sidebar-color-gradient-4" value="gradient-4">
                                    <label class="form-check-label p-0 avatar-xs rounded-circle"
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" v-model="sidebarImage" type="radio"
                                    name="data-sidebar-img" id="sidebarimg-none" value="none" />
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" v-model="sidebarImage" type="radio"
                                    name="data-sidebar-img" id="sidebarimg-01" value="img-1" />
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" v-model="sidebarImage" type="radio"
                                    name="data-sidebar-img" id="sidebarimg-02" value="img-2" />
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" v-model="sidebarImage" type="radio"
                                    name="data-sidebar-img" id="sidebarimg-03" value="img-3" />
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" v-model="sidebarImage" type="radio"
                                    name="data-sidebar-img" id="sidebarimg-04" value="img-4" />
                    ...
                    <div id="preloader-menu">
                        ...
                        <BRow>
                            <BCol cols="4">
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" v-model="preloader" type="radio"
                                        name="data-preloader" id="preloader-view-custom" value="enable">
                            ...
                            <BCol cols="4">
                                <div class="form-check sidebar-setting card-radio">
                                    <input class="form-check-input" v-model="preloader" type="radio"
                                        name="data-preloader" id="preloader-view-none" value="disable">
